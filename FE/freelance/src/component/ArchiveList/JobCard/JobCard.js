...
import { faEye, faCalendarAlt, faInfoCircle, faFlag, faUndo } from '@fortawesome/free-solid-svg-icons';

const JobCard = ({ title, date, status, description, detailLink, onRestore }) => {
  const buttonStyle = {
    width: '100%', 
    marginBottom: '8px'
  };
